...
import {
  SuperAdminEmployeeServices,
  SuperAdminCountryServices,
  SuperAdminMastersServices,
  SuperAdminAccountGroupHeadServices,
...
import {
  editStepOrder,
  getEditStepSchema,
} from "./employeeEditValidationSteps";
          ...
          <div key={key} className="text-center" style={{ minWidth: 110 }}>
            ...
            <div
              className={`small mt-1 ${
                i === currentIndex ? "fw-bold text-primary" : ""
              }`}
            >
              {labels[key]}
            </div>
...
const AdminEmployee = memo(() => {
  ...
  const fetchEmployeeData = async () => {
    try {
      ...
      const total =
        typeof res?.totalRecords === "number" ? res.totalRecords : rows.length;
      ...
      await Promise.allSettled([
        ...
        (async () => {
          try {
            setIsLoading(true);
            const res =
              await SuperAdminAccountGroupHeadServices.getAccountGroupHeads();
        ...
        (async () => {
          try {
            const res =
              await SuperAdminMastersServices.getDepartmentMasterData();
        ...
        (async () => {
          try {
            const res =
              await SuperAdminMastersServices.getDesignationMasterData();
        ...
        (async () => {
          try {
            const res =
              await SuperAdminMastersServices.getEmployeeIdMasterData();
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (confirmed) {
        ...
        const response = await SuperAdminEmployeeServices.deleteEmployee(
          payload
        );
        await fetchEmployeeData();
  ...
  const toExportRow = (r) => ({
    ...
    Mobile:
      r.mobileNo1 ||
      r.mobileNumberofficial ||
      r.contactNumberPersonal ||
      r.mobileNo2 ||
      r.phoneNo ||
      "",
      ...
      while (true) {
        ...
        const total =
          typeof res?.totalRecords === "number"
            ...
            ? res.totalCount
            : typeof res?.result?.totalCount === "number"
      ...
      <div className="masters-header">
        <div className="d-flex justify-content-between align-items-center">
          <div>
            ...
            <div className="breadcrumb">Manage Employee Master</div>
          </div>
          <Button
            variant="primary"
            size="lg"
              ...
              {tableLoading ? (
                ...
                employeeData.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td>
                      {item.mobileNo1 || item.mobileNumberofficial || "-"}
                    </td>
          ...
          {editingItem && (
            <Formik
              ...
              onSubmit={async (values, helpers) => {
                ...
                if (
                  modalSubmitIntent === "next" &&
                  editStepIndex < editStepOrder.length - 1
                ) {
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            name="doj"
                            value={
                              values.doj ? String(values.doj).split("T")[0] : ""
                            }
                            onChange={handleChange}
                            onBlur={handleBlur}
                          />
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            name="doc"
                            value={
                              values.doc ? String(values.doc).split("T")[0] : ""
                            }
                            onChange={handleChange}
                            onBlur={handleBlur}
                          />
                      ...
                      <Col md={4}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Check
                            ...
                            onChange={(e) =>
                              setFieldValue("isTDSApplicable", e.target.checked)
                            }
                          />
                        </Form.Group>
                      </Col>
                          ...
                          <Col md={4}>
                            <Form.Group className="mb-3">
                              ...
                              <Form.Control
                                ...
                                onBlur={handleBlur}
                                isInvalid={
                                  touched.tdsSection && !!errors.tdsSection
                                }
                  ...
                  <Form onSubmit={f.handleSubmit}>
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <Button
                        ...
                        onClick={() =>
                          setEditStepIndex((i) => Math.max(i - 1, 0))
                        }
                      >
                        Back
                      </Button>
